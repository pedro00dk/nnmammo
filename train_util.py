...
def validate_model_configurations_variations(model_class, sample_folds, original_folds, configurations,
    ...
    for i, configuration in enumerate(configurations):
        ...
        for j, variation_value in enumerate(variation_values):
            if verbose:
                print('variation %d of %d | %s -> %s' % (j + 1, len(variation_values), variation_name, variation_value))
